...
- Live RAG benchmark: 7 checks completed in 01:46 including Spring context startup, Neon connection, ingestion, embeddings, retrieval, generation, unsupported-question gating, and scope-isolation validation. This is an end-to-end test duration, not per-request latency.
