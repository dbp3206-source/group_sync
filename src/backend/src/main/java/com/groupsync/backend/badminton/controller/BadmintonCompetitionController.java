...
public class BadmintonCompetitionController {
    ...
    @GetMapping("/groups/{groupId}/players/{userId}/ranking-history") public List<MatchResponses.History> history(@AuthenticationPrincipal AuthenticatedUser actor, @PathVariable Long groupId, @PathVariable Long userId, @RequestParam Long seasonId) { return statisticsService.history(actor, groupId, seasonId, userId); }
    @GetMapping("/groups/{groupId}/players/{userId}/head-to-head") public MatchResponses.HeadToHead headToHead(@AuthenticationPrincipal AuthenticatedUser actor, @PathVariable Long groupId, @PathVariable Long userId, @RequestParam Long seasonId, @RequestParam Long opponentId) { return statisticsService.headToHead(actor, groupId, seasonId, userId, opponentId); }
    @GetMapping("/groups/{groupId}/players/{userId}/partners") public List<MatchResponses.PartnerStat> partners(@AuthenticationPrincipal AuthenticatedUser actor, @PathVariable Long groupId, @PathVariable Long userId, @RequestParam Long seasonId) { return statisticsService.partners(actor, groupId, seasonId, userId); }
    @GetMapping("/groups/{groupId}/players/{userId}/awards") public List<MatchResponses.Award> awards(@AuthenticationPrincipal AuthenticatedUser actor, @PathVariable Long groupId, @PathVariable Long userId, @RequestParam Long seasonId) { return statisticsService.awards(actor, groupId, seasonId, userId); }
}
