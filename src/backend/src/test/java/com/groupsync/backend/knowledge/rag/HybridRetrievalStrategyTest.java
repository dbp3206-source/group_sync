...
class HybridRetrievalStrategyTest {
    ...
    private final GeminiProperties properties = new GeminiProperties("key", "chat", "quality", "embedding", 768, 16, 6, 2, 12, 60, 30000);
    ...
    private final HybridRetrievalStrategy fuseOnlyStrategy = new HybridRetrievalStrategy(null, null,
            new GeminiProperties("key", "chat", "quality", "embedding", 768, 16, 6, 2, 12, 60, 30000));
