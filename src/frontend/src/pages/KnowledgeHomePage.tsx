...
export default function KnowledgeHomePage() {
  ...
  return <section className="kos-home">
    <div className="kos-home-copy"><p className="kos-kicker">PERSONAL KNOWLEDGE INTELLIGENCE</p><h1>Your knowledge,<br /><em>finally connected.</em></h1><p className="kos-lead">Collect what matters. Ask better questions. Return to the ideas worth your attention.</p><div className="kos-hero-actions"><Link className="kos-button kos-button--primary" to="/ask">Ask KnowledgeOS <ArrowUpRight size={17} /></Link><Link className="kos-text-link" to="/library">Open library</Link></div><p className="kos-greeting">Good to see you, {user?.displayName.split(' ')[0]}.</p></div>
