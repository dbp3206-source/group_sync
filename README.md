...
See `docs/SETUP_REPORT.md` for the exact machine/tool versions and the PostgreSQL setup decision. See `docs/IMPLEMENTATION_STATUS.md` for the current phase boundary. Badminton and external calendar synchronization are intentionally still out of scope for this checkpoint.
