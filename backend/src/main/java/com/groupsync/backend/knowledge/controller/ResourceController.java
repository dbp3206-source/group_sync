...
public class ResourceController {
    ...
    @GetMapping public List<ResourceResponse> list(@AuthenticationPrincipal AuthenticatedUser user, @RequestParam(required = false) String q) { return resourceService.list(user.getId(), q); }
