...
public class ResourceService {
    ...
    private final ResourceRepository resourceRepository; private final UserAccountRepository userRepository; private final StorageService storageService;
    public ResourceService(ResourceRepository resourceRepository, UserAccountRepository userRepository, StorageService storageService) { this.resourceRepository = resourceRepository; this.userRepository = userRepository; this.storageService = storageService; }
    @Transactional
    ...
    @Transactional public ResourceResponse retry(Long ownerId, Long resourceId) { Resource resource = find(ownerId, resourceId); resource.retry(); return ResourceResponse.from(resource); }
