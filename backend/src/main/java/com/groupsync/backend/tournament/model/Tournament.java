...
public class Tournament {
    ...
    public Tournament(Group group, Season season, BadmintonSession session, String name, String format, int maxParticipants) { this.group = group; this.season = season; this.session = session; this.name = name; this.format = format; this.maxParticipants = maxParticipants; }
    @PreUpdate void touch() { updatedAt = Instant.now(); }
    public Long getId() { return id; } public Group getGroup() { return group; } public Season getSeason() { return season; } public BadmintonSession getSession() { return session; } public String getName() { return name; } public String getFormat() { return format; } public TournamentStatus getStatus() { return status; } public int getMaxParticipants() { return maxParticipants; } public UserAccount getChampion() { return champion; }
